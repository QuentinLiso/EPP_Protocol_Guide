# EPP Samples - Domain Mapping (RFC 5731)

This document provides the samples of EPP messages for all the EPP operations related to **domains** defined in the RFC 5731.

---

# Table of Contents

- [1. Host name format](#1-host-name-format)
...
<domain:ns>
  <domain:hostAttr>
    ...
    <domain:hostAddr
      ip="v6">1080:0:0:0:8:800:200417A</domain:hostAddr>
  </domain:hostAttr>
  <domain:hostAttr>
